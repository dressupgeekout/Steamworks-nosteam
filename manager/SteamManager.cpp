...
extern "C" int SetOverlayPosition()
{
	return 0;
}

extern "C" int GetSteamID() { return 0; }
extern "C" int GetSteamName() { return 0; }
extern "C" int RequestCurrentStats() { return 0; }
