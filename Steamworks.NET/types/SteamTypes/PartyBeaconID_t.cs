...
namespace Steamworks {
	...
	public struct PartyBeaconID_t : System.IEquatable<PartyBeaconID_t>, System.IComparable<PartyBeaconID_t> {
		...
		public PartyBeaconID_t(ulong value) { m_PartyBeaconID = value; }
		public override string ToString() { return m_PartyBeaconID.ToString(); }
		public override bool Equals(object other) {
			return other is PartyBeaconID_t && this == (PartyBeaconID_t)other;
		}
		public override int GetHashCode() { return m_PartyBeaconID.GetHashCode(); }
