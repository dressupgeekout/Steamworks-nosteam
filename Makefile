...
all: Steamworks.NET/bin/Steamworks.NET.dll native wrapper
...
.PHONY: clean uninstall native wrapper
native:
	$(MAKE) -C native
...
uninstall:
	rm -f $(PREFIX)/lib/steamworks-nosteam/{Steamworks.NET.dll,lib{SteamworksNative,steamwrapper}.so.*}
