...
namespace Steamworks {
	public static class SteamApps {
		...
		public static uint GetEarliestPurchaseUnixTime(AppId_t nAppID) { return (uint) 0; }
		...
		public static bool MarkContentCorrupt(bool bMissingFilesOnly) { return false; }
		...
		public static bool BIsAppInstalled(AppId_t appID) { return false; }
		...
		public static string GetLaunchQueryParam(string pchKey) { return ""; }
		...
		public static SteamAPICall_t GetFileDetails(string pszFileName) { return (SteamAPICall_t) 0; }
		...
		public static bool BIsSubscribedFromFamilySharing() { return false; }
	}
}
