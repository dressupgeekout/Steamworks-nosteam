...
namespace Steamworks {
	public static class SteamClient {
		/// Creates a communication pipe to the Steam client.</para>
		/// NOT THREADSAFE - ensure that no other threads are accessing Steamworks API when calling</para>
		public static HSteamPipe CreateSteamPipe() { return (HSteamPipe) 0; }

		/// Releases a previously created communications pipe</para>
		/// NOT THREADSAFE - ensure that no other threads are accessing Steamworks API when calling
		public static bool BReleaseSteamPipe(HSteamPipe hSteamPipe) { return false; }

		/// connects to an existing global user, failing if none exists
		/// used by the game to coordinate with the steamUI
		/// NOT THREADSAFE - ensure that no other threads are accessing Steamworks API when calling
		public static HSteamUser ConnectToGlobalUser(HSteamPipe hSteamPipe) { return (HSteamUser) 0; }
